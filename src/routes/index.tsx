      ...
      {options.map((o) => {
        ...
        return (
          <button
            ...
            className={`group relative rounded-lg border-2 px-3 pt-3 pb-2 transition-all bg-secondary/30 min-h-[44px] ${
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <p className="mt-1 text-xs sm:text-sm font-light leading-tight">{o.label}</p>
          </button>
        );
      })}
    </div>
